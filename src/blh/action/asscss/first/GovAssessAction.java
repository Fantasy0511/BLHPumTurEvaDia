...
public class GovAssessAction extends AbstractActionSupport {
	...
	public String execute() throws Exception {
		...
		List<Double> barValue = Arrays.asList((double) govAssResult.getGovOilResult().get(5),
				(double) govAssResult.getGovSingleResult().get(3), (double) govAssResult.getHistory());
