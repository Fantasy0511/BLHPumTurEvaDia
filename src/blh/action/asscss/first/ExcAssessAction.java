...
public class ExcAssessAction extends AbstractActionSupport {
	...
	public String execute() throws Exception {
		...
		/**小窗口显示底层指标数据获取*/
		//励磁故障信号底层指标
		List<String> sonBarName1 = Arrays.asList("励磁电源故障", "电压/频率跳闸", "晶闸管桥风扇故障","有功功率测量值","励磁电压","机组频率","励磁电流");
		...
		BarData temperatureBar = BarData.create("励磁故障信号评估", "", "性能状态", "得分",sonBarName1, sonbarValue1);
		PieData temperaturePie = PieData.create("励磁故障信号评估指标得分", sonBarName1, sonbarValue1, "得分XXX");
		...
		BarData mainShaftSealBar = BarData.create("发电机故障信号评估指标", "", "性能状态", "得分",
