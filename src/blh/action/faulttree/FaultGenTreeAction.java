...
import service.faulttree.GenFaultTreeService;
 ...
 */
@Result(type = "json")
public class FaultGenTreeAction extends AbstractActionSupport {
	...
	public String execute() throws Exception {
		...
		results = new GenFaultTreeService().findfault(time, untiNo);
