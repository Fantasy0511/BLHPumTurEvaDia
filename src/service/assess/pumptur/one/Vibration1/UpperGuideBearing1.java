...
//上导轴承得分
public class UpperGuideBearing1 {
...
//	int U3=float838.FloatAssess(838,time, 800, 0);
	//上导轴承Y轴位移
	FloatAssessment float186=new FloatAssessment();
	int U4=float186.FloatAssess(186,time, 800, 0);
	...
	public static void main(String[] args) {
		UpperGuideBearing1 b=new UpperGuideBearing1();
