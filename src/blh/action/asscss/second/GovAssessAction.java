...
public class GovAssessAction extends AbstractActionSupport {
	...
	public String execute() throws Exception {
		...
		double[] values = { govAssResult2.getState2().get(0).doubleValue(),
		...
		List<Double> sonbarValue = Arrays.asList(govAssResult2.getState2().get(0).doubleValue(),
				govAssResult2.getState2().get(1).doubleValue(), govAssResult2.getState2().get(2).doubleValue(),
				govAssResult2.getState2().get(3).doubleValue(), govAssResult2.getState2().get(5).doubleValue());
		...
		List<Double> sonbarValue1 = Arrays.asList(govAssResult2.getSignalSum2().get(0).doubleValue(),
		...
		assessView = new AssessView(govAssResult2.getOutput2(), topRemark,
				...
				govAssResult2.getSignalSum2().get(3).doubleValue() + "", govAssResult2.getHistory2() + "", bottomDetail,
				middleBar);
