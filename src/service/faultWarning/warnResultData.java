...
public class warnResultData {
	...
	private List<String>  faultparameter;
	private WarnningResult  pro_fault;
	
	public warnResultData(WarnningResult pro_systems, List<String> faultparameter, WarnningResult pro_fault) {
		super();
	...
	public List<String> getFaultparameter() {
	...
	public void setFaultparameter(List<String> faultparameter) {
		this.faultparameter = faultparameter;
	}
