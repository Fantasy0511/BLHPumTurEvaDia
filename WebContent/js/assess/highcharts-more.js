...
(function(l, F) {
    ...
    H(K.prototype, {
        init: function(a, b, c) {
            ...
            d.options = a = o(e, b.angular ? {
                background: {}
            }: void 0, a); (a = a.background) && s([].concat(L(a)).reverse(),
            function(a) {
    ...
    O = {
        ...
        setAxisTranslation: function() {
            ...
            if (this.center) this.transA = this.isCircular ? (this.endAngleRad - this.startAngleRad) / (this.max - this.min || 1) : this.center[2] / 2 / (this.max - this.min || 1),
        ...
        getPlotBandPath: function(a, b, c) {
            ...
            k,
            m = this.isCircular;
            this.options.gridLineInterpolation === "polygon" ? d = this.getPlotLinePath(a).concat(this.getPlotLinePath(b, !0)) : (a = Math.max(a, this.min), b = Math.min(b, this.max), m || (i[0] = this.translate(a), i[1] = this.translate(b)), i = R(i,
            function(a) {
        ...
        getPlotLinePath: function(a, b) {
            ...
            g,
            k;
            c.isCircular ? k = ["M", d[0] + e.plotLeft, d[1] + e.plotTop, "L", f.x, f.y] : c.options.gridLineInterpolation === "circle" ? (a = c.translate(a)) && (k = c.getLinePath(0, a)) : (s(e.xAxis,
            function(a) {
                a.pane === c.pane && (i = a)
            }), k = [], a = c.translate(a), d = i.tickPositions, i.autoConnect && (d = d.concat([d[0]])), b && (d = [].concat(d).reverse()), s(d,
            function(f, c) {
                g = i.getPosition(f, a);
    ...
    function(a, b, c) {
        ...
        this.defaultRadialOptions = (g = f) ? this.defaultRadialXOptions: o(this.defaultYAxisOptions, this.defaultRadialYOptions);
        a.call(this, b, c);
        if (!i && (d || e)) {
            a = this.options;
            if (!b.panes) b.panes = [];
    ...
    u(y, "getLabelPosition",
    function(a, b, c, d, e, f, i, g, k) {
        var m = this.axis,
        j = f.y,
        n = 20,
        h = f.align,
        A = (m.translate(this.pos) + m.startAngleRad + Math.PI / 2) / Math.PI * 180 % 360;
        m.isRadial ? (a = m.getPosition(this.pos, m.center[2] / 2 + q(f.distance, -25)), f.rotation === "auto" ? d.attr({
            rotation: A
    ...
    h.arearange = v(h.area, {
        ...
        translate: function() {
            ...
            this.chart.polar && s(this.points,
            function(c) {
                a.highToXY(c)
            })
        },
        ...
        drawDataLabels: function() {
            ...
            if (f.enabled || this._hasPointLabels) {
                for (c = b; c--;) if (g = a[c]) if (k = g.plotHigh > g.plotLow, g.y = g.high, g._plotY = g.plotY, g.plotY = g.plotHigh, d[c] = g.dataLabel, g.dataLabel = g.dataLabelUpper, g.below = k, m) {
    ...
    h.boxplot = v(h.column, {
        ...
        drawPoints: function() {
            ...
            c = a.options,
            d = a.chart.renderer,
            e, f, i, g, k, m, j, n, h, A, l, J, p, o, u, r, v, t, w, x, z, y, E = a.doQuartiles !== !1,
            ...
            function(b) {
                ...
                r = {};
                y = b.color || a.color;
                if (b.plotY !== F) if (e = b.pointAttr[b.selected ? "selected": ""], v = z.width, t = B(z.x), w = t + v, x = D(v / 2), f = B(E ? b.q1Plot: b.lowPlot), i = B(E ? b.q3Plot: b.lowPlot), g = B(b.highPlot), k = B(b.lowPlot), l.stroke = b.stemColor || c.stemColor || y, l["stroke-width"] = q(b.stemWidth, c.stemWidth, c.lineWidth), l.dashstyle = b.stemDashStyle || c.stemDashStyle, o.stroke = b.whiskerColor || c.whiskerColor || y, o["stroke-width"] = q(b.whiskerWidth, c.whiskerWidth, c.lineWidth), r.stroke = b.medianColor || c.medianColor || y, r["stroke-width"] = q(b.medianWidth, c.medianWidth, c.lineWidth), j = l["stroke-width"] % 2 / 2, n = t + x + j, A = ["M", n, i, "L", n, g, "M", n, f, "L", n, k], E && (j = e["stroke-width"] % 2 / 2, n = B(n) + j, f = B(f) + j, i = B(i) + j, t += j, w += j, J = ["M", t, i, "L", t, f, "L", w, f, "L", w, i, "L", t, i, "z"]), C && (j = o["stroke-width"] % 2 / 2, g += j, k += j, p = ["M", n - x * C, g, "L", n + x * C, g, "M", n - x * C, k, "L", n + x * C, k]), j = r["stroke-width"] % 2 / 2, m = D(b.medianPlot) + j, u = ["M", t, m, "L", w, m], h) b.stem.animate({
                    d: A
                }),
    ...
    h.waterfall = v(h.column, {
        ...
        translate: function() {
            ...
            for (c = 0, a = d.length; c < a; c++) {
                ...
                if (e.isSum) f.y = b.translate(j[1], 0, 1),
                f.height = Math.min(b.translate(j[0], 0, 1), b.len) - f.y;
                else if (e.isIntermediateSum) f.y = b.translate(j[1], 0, 1),
                f.height = Math.min(b.translate(m, 0, 1), b.len) - f.y,
                m = j[1];
                else {
        ...
        processData: function(a) {
            ...
            for (j = 0; j < e; j++) m = b[j],
            d = c && c[j] ? c[j] : {},
            m === "sum" || d.isSum ? b[j] = i: m === "intermediateSum" || d.isIntermediateSum ? b[j] = f: (i += m, f += m),
            g = Math.min(i, g),
            k = Math.max(i, k);
        ...
        getGraphPath: function() {
            ...
            a[i - 1].y < 0 && (f[2] += e.height, f[5] += e.height),
            d = d.concat(f);
            return d
        },
        getExtremes: r,
    ...
    h.bubble = v(h.scatter, {
        ...
        getRadii: function(a, b, c, d) {
            ...
            m = b - a;
            for (e = 0, b = i.length; e < b; e++) i[e] < a ? g.push(c / 2 - 1) : (f = m > 0 ? (i[e] - a) / m: 0.5, k && f >= 0 && (f = Math.sqrt(f)), g.push(w.ceil(c + f * (d - c)) / 2));
            this.radii = g
        },
        animate: function(a) {
    ...
    M.prototype.beforePadding = function() {
        ...
        function(b) {
            var g = b.options;
            if (b.bubblePadding && (b.visible || !c.options.chart.ignoreHiddenSeries)) if (a.allowZoomOutside = !0, p.push(b), f) s(["minSize", "maxSize"],
            function(a) {
                var b = g[a],
                f = /%$/.test(b),
                b = x(b);
            ...
            b.maxPxSize = k.maxSize,
            b = b.zData,
            b.length && (j = q(g.zMin, w.min(j, w.max(P(b), g.displayNegative === !1 ? g.zThreshold: -Number.MAX_VALUE))), n = q(g.zMax, w.max(n, Q(b))))
        });
        s(p,
        function(a) {
            var b = a[i],
        ...
        p.length && h > 0 && !this.isLog && (e -= b, l *= (b + d - e) / b, s([["min", "userMin", d], ["max", "userMax", e]],
        function(b) {
        ...
        h.spline && u(h.spline.prototype, "getPointSpline",
        function(a, b, c, d) {
            var e, j, n, h, l, p, o;
            if (this.chart.polar) {
                e = c.plotX;
                ...
                n = (1.5 * e + b) / 2.5,
                o = (1.5 * j + p) / 2.5,
                b = Math.sqrt(Math.pow(h - e, 2) + Math.pow(l - j, 2)),
                p = Math.sqrt(Math.pow(n - e, 2) + Math.pow(o - j, 2)),
                h = Math.atan2(l - j, h - e),
                l = Math.atan2(o - j, n - e),
                o = Math.PI / 2 + (h + l) / 2,
        ...
        u(c, "animate", b);
        if (h.column) e = h.column.prototype,
        u(e, "animate", b),
        u(e, "translate",
        function(a) {
            var b = this.xAxis,
