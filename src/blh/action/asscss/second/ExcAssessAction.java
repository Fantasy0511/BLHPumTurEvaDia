...
public class ExcAssessAction extends AbstractActionSupport {
	...
	public String execute() throws Exception {
		...
		String[] names = { "励磁电源故障", "电压/频率跳闸", "晶闸管桥风扇故障", "励磁电压a", "机组频率", "转子绝缘报警次数", "发电机停止报警次数", "频率保护报警",
				"发电机热风温度", "发电机冷风温度", "空冷器出水温度", "励磁电流", "励磁电压b" };
		...
		List<Double> sonbarValue3 = Arrays.asList(excAssResult.getIndicator().get(11).doubleValue(),
		...
		List<Double> sonbarValue4 = Arrays.asList(excAssResult.getIndicator().get(14).doubleValue(),
				excAssResult.getIndicator().get(15).doubleValue(), excAssResult.getIndicator().get(16).doubleValue());
		...
		List<Double> sonbarValue5 = Arrays.asList(excAssResult.getIndicator().get(17).doubleValue(),
